...
<head>
    ...
    <title>Tigers Explore Rochester</title>
            ...
            <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="sec_menu col-12">
                        <ul>
                            <li class="sm_item"><a class="sec_menu_links"href="#">Rochester</a></li>
                            <li class="sm_item"><a class="sec_menu_links"href="#">Syracuse</a></li>
                            <li class="sm_item"><a class="sec_menu_links"href="#">Buffalo</a></li>
                        </ul>
                    </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-lg-10">
                            ...
                            <p>Cobb's Hill is a part located toward the south-east end of the city (the part closest to RIT). The park is apprximately 109 acres. Inside the park you will find a variety of walking trails, beautiful forestry including lilac trees.</p>

                            <p>Cobb's Hill is a favorite spot for runners, who like to do laps around the park's water filled basin, as well as Lake Riley, which can be found at the park's entrance, and which also attracts sunbathers in the warmer months.</p>
                        ...
                        <div class="col-xs-12 col-lg-3">
                            ...
                            <ul>
                                <li>Phone: 585-428-6770</li>
                                <li>Address: 100 Noris Drive, Rochester NY 14623</li>
                            </ul>
                        </div>
                        ...
                        <section class="row">
                            ...
                            <p> In addition to the amazing views, the park offers many activities for visitors to enjoy. From Swimming pools, fishing areas, hiking trails, hot ballooning, and even white-water rafting and canoeing there are activities that everyone can enjoy (Source). Additionally the park staff organize special events throughout the year from festivals, to guided tours and even arts and crafts (Source). As such the park is one of the most diverse and amazing parks in the region and is only a short 40 minute drive from Rochester Institute of Technology.</p>
