                ...
                <div class="container-fluid"> 
                    ...
                    <div class="sec_menu col-12">
                        ...
                        <div class="col-xs-12 col-lg-10">
                            ...
                            <div class="row">
                            <h2 id="Cobbs">Marketplace</h2>
                            </div>
                            
                            <div class="row">
                            <div class="container col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <figure>
                                    <img class="sm_img" width="90%" src="img/marketplace.jpg" alt="Marketplace Mall">
                                    <figcaption><a href="http://www.themarketplacemall.com/Data/RotatingImages/rotating_mpm.jpg">Image Source</a></figcaption>
                                </figure>
                            </div>
                            </div>
                            ...
                            <h3>About the Marketplace Mall</h3>

                            <p>
                                Located just around the corner from RIT, The Marketplace Mall provides a convenient shopping location for students. This mall has over 100 stores and services which even includes a go-kart racing track, Pole Position Raceway. Another popular location for students in the mall is Dave and Buster’s. But for practical shopping, there is another plaza next to the mall which has a Target and a Best Buy. If students wish to go grocery shopping off-campus, there is a Wegmans across from the mall as well.
                            </p>
                        ...
                        <div class="col-xs-12 col-lg-4">
                            ...
                            <ul>
                                <li>Phone: (585)-475-0757</li>
                                <li>Address: 1 Miracle Mile Dr, Rochester, NY 14623 </li>
                            </ul>
                        </div>
